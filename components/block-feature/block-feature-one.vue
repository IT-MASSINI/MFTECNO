		...
		<div class="upper-wrapper mb-110 lg-mb-80">
			<div class="container">
				<div class="row">
					...
					<div v-for="(item, i) in upper_data" :key="i" class="col-lg-4 wow fadeInUp"
		...
		<div class="container">
			<div class="position-relative">
				...
				<div class="row justify-content-center">
					<div v-for="item in service_data" :key="item.id" class="col-lg-4 col-md-6 d-flex wow fadeInUp"
