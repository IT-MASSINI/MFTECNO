<template>
  <header :class="`theme-main-menu menu-overlay menu-style-six sticky-menu ${isSticky?'fixed':''}`">
          ...
          <div class="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
            <ul class="d-flex align-items-center style-none">
              <li class="d-flex align-items-center login-btn-two">
                <img src="/images/icon/icon_94.svg" alt="" class="lazy-img icon me-2"/>
                <a
                  href="#"
              ...
              <li class="d-none d-md-inline-block ms-3 ms-xl-4">
                <a
                  ...
                  data-bs-toggle="modal"
                  data-bs-target="#loginModal"
                  class="fw-500 signup-btn-two tran3s">
                  Sign Up
                </a>
              </li>
            </ul>
